...
class JwtProviderTest : KoinTest {
    ...
    fun `verifies access token generated + token fields`() {
        ...
        val decoded: DecodedJWT = jwtProvider.verify(tokenPair.access, JwtProvider.TokenType.ACCESS).getOrThrow()
    ...
    fun `verifies refresh token generated & token fields are valid`() {
        ...
        val decoded: DecodedJWT = jwtProvider.verify(tokenPair.refresh, JwtProvider.TokenType.REFRESH).getOrThrow()
